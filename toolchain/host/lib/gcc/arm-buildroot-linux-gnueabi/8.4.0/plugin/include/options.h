...
enum opt_code
{
  ...
  OPT_mlong_calls = 1219,                    /* -mlong-calls */
  OPT_mmusl = 1220,                          /* -mmusl */
  OPT_mneon_for_64bits = 1221,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1222,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1223,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1224,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1225,               /* -mprint-tune-info */
  OPT_mpure_code = 1226,                     /* -mpure-code */
  OPT_mrestrict_it = 1227,                   /* -mrestrict-it */
  OPT_msched_prolog = 1228,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1229,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1230,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1231, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1232,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1233,                         /* -mthumb */
  OPT_mthumb_interwork = 1234,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1235,                  /* -mtls-dialect= */
  OPT_mtp_ = 1236,                           /* -mtp= */
  OPT_mtpcs_frame = 1237,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1238,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1239,                         /* -mtune= */
  OPT_muclibc = 1240,                        /* -muclibc */
  OPT_munaligned_access = 1241,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1242,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1243,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1244,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1245,              /* -mword-relocations */
  OPT_n = 1246,                              /* -n */

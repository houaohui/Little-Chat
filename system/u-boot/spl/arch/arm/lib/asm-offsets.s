...
@ -I ./arch/arm/thumb1/include -I ./arch/arm/include
@ -I ./arch/arm/mach-sunxi/include -imultiarch arm-linux-gnueabi
...
@ -mthumb -mthumb-interwork -mabi=aapcs-linux -mfloat-abi=soft
@ -mtls-dialect=gnu -march=armv5te
...
@ -fmacro-prefix-map=./= -fstack-usage -ffunction-sections -fdata-sections
...
.LASF40:
	...
	.ascii	"-linux -mfloat-abi=soft -mtls-dialect=gnu -march=ar"
	.ascii	"mv5te -g -Os -std=gnu11 -fno-builtin -ffreestanding"
	.ascii	" -fshort-wchar -fno-strict-aliasing -fno-PIE -fno-s"
	.ascii	"tack-protector -fno-delete-null-pointer-checks -fst"
	.ascii	"ack-usage -ffunction-sections -fdata-sections -fno-"
